...
dg.add_title_line(doc, "Data Engineer — Data Pipelines, Canonical Datasets & Distributed Data Systems")

dg.add_summary(doc,
    "Data engineer with 12 years of experience designing and operating the data pipelines, canonical datasets, "
    "and data-quality systems that power analytics at scale. Built data ingestion and pipelining for 220+ "
    "unique data sources from the ground up as an early startup hire, including a Common Information Model "
    "(data dictionary) standardizing field names and types across every pipeline — the same canonical-dataset "
    "discipline this role calls for tracking key people and product metrics. Deep hands-on experience with "
    "PySpark, GCP Dataproc, and BigQuery for large-scale distributed data processing, plus a homegrown Apache "
    "Beam program on GCP Dataflow for historical/cold-storage data retrieval. Comfortable serving as the "
    "primary data engineer on a small, fast-moving team and working across stakeholder groups to turn business "
    "needs into reliable, fault-tolerant data infrastructure."
)
...
dg.add_skills_line(doc, "Data Engineering & Pipelines",
    ...
    "design and standardization; fault-tolerant data ingestion and processing systems; data-quality monitoring "
    "and alerting; connector/collector health monitoring and troubleshooting")
...
dg.add_bullet(doc, "Built an entirely new data ingestion platform from the ground up for a federal client — "
                   ...
                   "analytics layer built on top of the pipeline output, data-quality monitoring and alerting "
...
dg.add_bullet(doc, "Currently create and manage analytics content that turns raw event data into decision-"
                   "ready outputs for case and incident workflows — the same data-to-metrics pipeline "
                   "discipline this role's canonical-dataset and people-metrics work requires (Treasury SOC / "
                   "TSSOC, current project).")
...
dg.add_cover_paragraph(cl,
    "I'd like to bring my data engineering background to People Innovation Labs' work building the pipelines "
    "and canonical datasets that will power products like OpenHouse and the People Analytics function's "
    "day-to-day work."
)
cl_body = (
    ...
    "we ran. That last piece maps directly onto this role's charge to develop canonical datasets tracking key "
    "people and product metrics. I also built a homegrown Apache Beam program run on GCP Dataflow to retrieve "
    "large volumes of historical cold-storage data, and ran exploratory data analysis at scale on GCP Dataproc "
    "clusters using PySpark and SparkSQL — the same distributed-processing muscle this role calls for with "
    "Spark."
)
dg.add_cover_paragraph(cl, cl_body)
dg.add_cover_paragraph(cl,
    "Throughout my career I've served as the primary data engineer on small, fast-moving teams, working "
    "cross-functionally with data science, product, and business stakeholders to turn raw, high-volume data "
    "into reliable, fault-tolerant systems those teams could trust for decision-making — including sustained "
    "ownership of data-quality monitoring, alerting, and the security/integrity/compliance posture of the data "
    "itself. I'd bring that same ownership mindset to building the data systems behind People Innovation Labs' "
    "products."
)
dg.add_cover_paragraph(cl,
    "I'd welcome the opportunity to talk through how this experience applies to building OpenAI's people data "
    "platform."
)
dg.add_cover_paragraph(cl, "Kyle Main", after=0)

dg.save(cl, os.path.join(OUT, "cover_letter.docx"))
print("OpenAI Data Engineer, People Innovation Labs package built.")
